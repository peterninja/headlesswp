                ...
                <div className="container">
                    <div className="row mb-lg-5 mb-4">
                        <div className="col-12">
                            <div className="blog-post-img wrapper-gsap">
                                <img src="assets/images/blog-post1.webp" alt=""/>
                    ...
                    <div className="row">
                        <div className="col-xl-9 col-lg-8 blog-detail-info">
                            <p>We’ve improved our dashboard enabling you to manage your Liveblocks app more efficiently—you can now create multiple projects and easily roll new API keys!</p>
